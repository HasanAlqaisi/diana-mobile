                        ...
                        children: [
                          GestureDetector(
                              ...
                              child: DayText(
                                  text: 'Mon',
                                  color:
                                      _colorDayText(weekDay: 0, controller: _),
                                  hasBorder: false)),
                          GestureDetector(
                              key: ValueKey('Tue'),
                              onTap: () {
                              ...
                              child: DayText(
                                  text: 'Tue',
                                  color:
                                      _colorDayText(weekDay: 1, controller: _),
                                  hasBorder: false)),
                          GestureDetector(
                              key: ValueKey('Wed'),
                              onTap: () {
                              ...
                              child: DayText(
                                  text: 'Wed',
                                  color:
                                      _colorDayText(weekDay: 2, controller: _),
                                  hasBorder: false)),
                          GestureDetector(
                              key: ValueKey('Thu'),
                              onTap: () {
                              ...
                              child: DayText(
                                  text: 'Thu',
                                  color:
                                      _colorDayText(weekDay: 3, controller: _),
                                  hasBorder: false)),
                          GestureDetector(
                              key: ValueKey('Fri'),
                              onTap: () {
                              ...
                              child: DayText(
                                  text: 'Fri',
                                  color:
                                      _colorDayText(weekDay: 4, controller: _),
                                  hasBorder: false)),
                          GestureDetector(
                              key: ValueKey('Sat'),
                              onTap: () {
                              ...
                              child: DayText(
                                  text: 'Sat',
                                  color:
                                      _colorDayText(weekDay: 5, controller: _),
                                  hasBorder: false)),
                          GestureDetector(
                              key: ValueKey('Sun'),
                              onTap: () {
                              ...
                              child: DayText(
                                  text: 'Sun',
                                  color:
                                      _colorDayText(weekDay: 6, controller: _),
                                  hasBorder: false))
                        ],
                      ),
                    ),
